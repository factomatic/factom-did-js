...
class DIDVersionUpgrader {
  ...
  exportEntryData() {
    const signingKey = this.didBuilder._managementKeys.sort((a, b) => a.priority - b.priority)[0];
    ...
    const dataToSign = "".concat(EntryType.VersionUpgrade, ENTRY_SCHEMA_V100, signingKeyId, entryContent);

...
describe('Test Services', function() {
  it('should add services', function() {
    ...
    const did = DID.builder()
      ...
      .service(secondServiceAlias, secondServiceType, secondServiceEndpoint, secondServicePriorityRequirement)
      .service(thirdServiceAlias, thirdServiceType, thirdServiceEndpoint, thirdServicePriorityRequirement, thirdServiceCustomFields)
      .build();
    ...
    assert.strictEqual(secondGeneratedService.priorityRequirement, secondServicePriorityRequirement);
    ...
    assert.strictEqual(thirdGeneratedService.priorityRequirement, thirdServicePriorityRequirement);
  ...
  it('should throw error if priorityRequired is invalid', function() {
    ...
    testCases.forEach((priorityRequirement, index) => {
      assert.throw(
        () => builder.service(`service-${index}`, serviceType, serviceEndpoint, priorityRequirement),
  ...
  it('should throw error if customFields is invalid', function() {
    ...
    testCases.forEach((customFields, index) => {
      assert.throw(
        () => builder.service(`service-${index}`, serviceType, serviceEndpoint, undefined, customFields),
